...
def user_roles(request):
    ...
    **Functionality**
    - Checks if the authenticated user belongs to the "Event User" or "Event Organiser" groups.
    - Determines the user's role based on their group membership.

    **Returns**
    - A dictionary with the following keys:
        - `is_event_user` (bool): True if the user belongs to the "Event User" group; otherwise, False.
        - `is_event_organiser` (bool): True if the user belongs to the "Event Organiser" group; otherwise, False.

    **Usage**
    - Typically used as a context processor to make user role information globally available in templates.
